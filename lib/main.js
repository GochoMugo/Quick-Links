...
QL_var.panel = require('sdk/panel').Panel({
	...
	contentScriptFile: [QL_var.data.url('jquery/jquery-1.10.2.js'), QL_var.data.url('bootstrap/dist/js/bootstrap.min.js'), QL_var.data.url('js/add.js')], // JS file
...
QL_var.widget = require('sdk/widget').Widget({
	...
	contentScriptFile: [QL_var.data.url('jquery/jquery-1.10.2.js'), QL_var.data.url('js/defaults.js'), QL_var.data.url('js/main.js')], // JS files for the html document
	contentScriptWhen: 'ready',
	onAttach: function () {
